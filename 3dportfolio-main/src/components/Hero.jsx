...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>
            Hi, I'm <span className="text-[#915EFF]">Nourhene</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-slate-800`}>
            I build aesthetic and pixel-perfect websites  <br /> If you ask
            :&#41;
          </p>
      ...
      <div className="absolute w-full sm:w-[60%] h-screen sm:right-[1%]">
        <ComputersCanvas />
      </div>
